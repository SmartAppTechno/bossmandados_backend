...
namespace BossmandadosAPIService.Models
{
    public class BossmandadosAPIContext : DbContext
    {
        ...
        public DbSet<Manboss_repartidor_ubicacion> Manboss_repartidores_ubicacion { get; set; }
        ...
        public DbSet<Manboss_direcciones> Manboss_direcciones { get; set; }
        ...
        public DbSet<Manboss_promociones> Manboss_promociones { get; set; }
